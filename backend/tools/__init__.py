...
NOTEWRITER_TOOLS = [get_learning_style, list_files, read_file, search_documents, notion_search, notion_get_page, notion_create_page]
ADVISOR_TOOLS = [get_learning_style, get_student_goals, get_task_by_priority, search_documents, notion_search]
